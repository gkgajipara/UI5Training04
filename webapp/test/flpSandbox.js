		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5 Training 04",
									"targetURL": "#atclouddnatraining04zhoui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"atclouddnatraining04zhoui5-display": {
								"semanticObject": "atclouddnatraining04zhoui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=at.clouddna.training04.zhoui5",
									"url": sap.ui.require.toUrl("at/clouddna/training04/zhoui5")
								}
							}
						}
					}
